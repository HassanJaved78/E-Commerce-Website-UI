...
export default function Header() {
  return (
    <nav className="box-border border-b border-black/20 flex sm:w-4/5 mt-2 justify-between items-center mx-auto p-2 font-serif gap-4 md:gap-12">
      ...
      <div className="flex lg:flex-1 max-w-sm justify-between items-center gap-2 xl:gap-4 xl:justify-around">
        ...
        <Bars3Icon className="w-6 h-6 cursor-pointer sm:hidden" />
      </div>
    </nav>
  );
}
